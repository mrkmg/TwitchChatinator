...
namespace TwitchChatinator.Forms.Setups
{
    public partial class SetupPieGraph : Form
    {
        ...
        private RunPollPie _runPollPie;
        ...
        {
            if (_runPollPie != null && !_runPollPie.IsDisposed)
            {
                _runPollPie.Close();
            }
        }
        ...
        private void RefreshPreview()
        {
            ...
            SetOptionsToValues();
            PieGraphOptions.PreviewOptions = _options;
            ...
            _runPollPie = new RunPollPie(DateTime.MinValue, "_preview", "Demo Poll", vals);
            _runPollPie.Show();
            Focus();
        }
